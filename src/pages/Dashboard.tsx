...
export default function Dashboard() {
  ...
  return (
    <div className="h-screen flex flex-col bg-background overflow-hidden">
      {/* Header */}
      <header className="flex-shrink-0 w-full border-b bg-background/80 backdrop-blur-lg">
      ...
      <div className="flex-1 min-h-0 grid grid-cols-1 lg:grid-cols-[2fr_3fr] gap-4 p-4 max-w-screen-2xl mx-auto w-full">
        {/* Left Column – New Session (full height) */}
        <Card className="border bg-card flex flex-col min-h-0">
            ...
            <PlanSelector
              onSessionStart={() => {
                ...
                toast({
                  ...
                  description: "Your new session is ready. Click it to start chatting.",
                });
              }}
            />
          </CardContent>
        ...
        <div className="flex flex-col gap-4 min-h-0">
          {/* Top-right: Active Sessions */}
          <Card className="border bg-card flex flex-col min-h-0 flex-1 basis-0">
            <CardHeader className="pb-2 pt-4 px-4 flex-shrink-0">
            ...
            <CardContent className="px-4 pb-4 flex-1 min-h-0">
              {activeSessions.length === 0 ? (
                <div className="flex flex-col items-center justify-center h-full text-center">
                  ...
                  <p className="text-xs text-muted-foreground/70 mt-0.5">Purchase a plan to get started</p>
                </div>
              ) : (
          ...
          {/* Bottom-right: All Conversations */}
          <Card className="border bg-card flex flex-col min-h-0 flex-1 basis-0">
            <CardHeader className="pb-2 pt-4 px-4 flex-shrink-0">
              <CardTitle className="text-sm font-medium">All Conversations</CardTitle>
              <CardDescription className="text-xs">Your complete session history</CardDescription>
            </CardHeader>
            <CardContent className="px-4 pb-4 flex-1 min-h-0">
